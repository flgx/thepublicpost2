        ...
        <?php $id=$video->id; ?>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 col-lg-offset-0 col-mds-offset-0 col-xs-offset-0 post">
                ...
                <div class="col-lg-10 col-md-10 col-sm-9 col-xs-12 portafolio-content">
                    <!-- Projects Row -->
                <div class="user col-lg-2 col-md-2 col-sm-2 col-xs-12">   @if(Auth::user()->first()->profile_image && Auth::user()->first()->facebook_id == null && Auth::user()->first()->twitter_id == null)
                        ...
                        @elseif(Auth::user()->first()->facebook_id != null || Auth::user()->first()->twitter_id != null)
                        <img style="max-width:80px" alt="" class="img-circle" src="{{Auth::user()->first()->profile_image}}" alt="The Public Post">
                        @endif
                    <p class="text-center user-name">{{$video->user()->first()->name}}</p>
...
$.ajax({
    ...
    url: '{{ url('/admin/videos/addView') }}' + '/' + dataId,
    type: 'POST',
