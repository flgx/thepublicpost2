...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            <img class="img-responsive center-block banner-ad2 p-tb10" width="728" height="90" src="{{asset('img/banner_ad.png')}}" alt="banner_ad">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-8 col-lg-offset-2 m-b20 nopadding">
                    <img class="ebook img-responsive center-block" src="{{asset('img/ebooks/slider_'.$ebook->images()->first()->name)}}" alt="">
                </div>
  ...
  @foreach($related_ebooks as $ebook)
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4 portafolio-item">
          <a href="#" class="td-n">
              <img class="img-responsive" src="{{asset('img/ebooks/slider_'.$ebook->images()->first()->name)}}" alt="">
